import{j as e}from"./index-BOFBJEO0.js";import{g as h,M as b,bd as y,be as g,T as w,a as v,Y as x,bf as o,bg as d,bh as u,S as p,p as r,bi as c}from"./style-FasjCHlg.js";import{r as V}from"./iframe-B0xXvuir.js";import{s as C}from"./sample_polygon_1-C4T77cfz.js";import"./index-gVbYFzJF.js";import"./preload-helper-D9Z9MdNV.js";const l=t=>[(i,s)=>{const m=V.useMemo(()=>h(s?.globals?.theme),[s?.globals?.theme]);return e.jsx("div",{className:"fullscreen_map",children:e.jsx(b,{children:e.jsx(y,{store:g,children:e.jsxs(w,{theme:m,children:[e.jsx(i,{}),e.jsx(v,{options:{zoom:12.5,style:"https://wms.wheregroup.com/tileserver/style/osm-bright.json",center:[7.0851268,50.73884],...t?{...t}:{}},mapId:"map_1"}),e.jsx(x,{showZoomButtons:!1,mapId:"map_1"})]})})})})}],T=l({});try{l.displayName="makeMapContextDecorators",l.__docgenInfo={description:"",displayName:"makeMapContextDecorators",props:{hash:{defaultValue:null,description:`If \`true\`, the map's position (zoom, center latitude, center longitude, bearing, and pitch) will be synced with the hash fragment of the page's URL.
