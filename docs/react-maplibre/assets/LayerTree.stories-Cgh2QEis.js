import{j as e}from"./index-CDJtynmm.js";import{g as h,M as b,be as y,bf as g,T as w,a as v,Y as x,bg as o,bh as d,bi as u,S as p,p as r,bj as c}from"./style-EQxhJZjY.js";import{r as C}from"./iframe-XTL4KZp0.js";import{s as V}from"./sample_polygon_1-C4T77cfz.js";import"./index-BVv5nCR3.js";import"./preload-helper-D9Z9MdNV.js";const l=t=>[(i,s)=>{const m=C.useMemo(()=>h(s?.globals?.theme),[s?.globals?.theme]);return e.jsx("div",{className:"fullscreen_map",children:e.jsx(b,{children:e.jsx(y,{store:g,children:e.jsxs(w,{theme:m,children:[e.jsx(i,{}),e.jsx(v,{options:{zoom:12.5,style:"https://wms.wheregroup.com/tileserver/style/osm-bright.json",center:[7.0851268,50.73884],...t?{...t}:{}},mapId:"map_1"}),e.jsx(x,{showZoomButtons:!1,mapId:"map_1"})]})})})})}],T=l({});try{l.displayName="makeMapContextDecorators",l.__docgenInfo={description:"",displayName:"makeMapContextDecorators",props:{hash:{defaultValue:null,description:`If \`true\`, the map's position (zoom, center latitude, center longitude, bearing, and pitch) will be synced with the hash fragment of the page's URL.
